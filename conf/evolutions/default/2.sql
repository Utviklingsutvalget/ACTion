...
INSERT INTO `action`.`powerup` (`id`, `class_name`, `friendly_name`, `is_mandatory`)
VALUES ('1', 'core.descriptionpowerup.DescriptionPowerup', 'Beskrivelse', '1'),
  ('2', 'core.clubimage.ClubImagePowerup', 'Utvalgsbilde', '1');
