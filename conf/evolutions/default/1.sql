...
alter table pending add constraint fk_pending_club_info_16 foreign key (club_id) references club_info (club_id) on delete restrict on update restrict;
create index ix_pending_club_info_16 on pending (club_id);
