...
alter table board_membership add constraint fk_board_membership_club_info_1 foreign key (club_id) references club_info (club_id) on delete restrict on update restrict;
create index ix_board_membership_club_info_1 on board_membership (club_id);
alter table board_membership add constraint fk_board_membership_club_2 foreign key (club_id) references club (id) on delete restrict on update restrict;
create index ix_board_membership_club_2 on board_membership (club_id);
alter table board_membership add constraint fk_board_membership_boardPost_3 foreign key (board_post_id) references board_post (id) on delete restrict on update restrict;
create index ix_board_membership_boardPost_3 on board_membership (board_post_id);
alter table board_membership add constraint fk_board_membership_user_4 foreign key (user_id) references user (id) on delete restrict on update restrict;
create index ix_board_membership_user_4 on board_membership (user_id);
alter table club add constraint fk_club_location_5 foreign key (location_id) references location (id) on delete restrict on update restrict;
create index ix_club_location_5 on club (location_id);
...
alter table pending add constraint fk_pending_club_info_18 foreign key (club_id) references club_info (club_id) on delete restrict on update restrict;
create index ix_pending_club_info_18 on pending (club_id);
...
drop sequence if exists club_info_seq;
