...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = {timestamp: "E5OD", version: "4.4.2", revision: "1567b48", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return{define: function (b, d) {
            ...
            function h(a, m, o, p) {
                a = {name: b, sender: this, editor: a, data: m, listenerData: c, stop: o, cancel: p, removeListener: i};
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, c = function (a, d) {
            ...
            return e
        }, b = {}, f = {}, d = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, e = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, n = {"#": 1}, h = {center: 1, dir: 1, noframes: 1};
    ...
    (function () {
        ...
        {clone: function () {
            ...
            return function (b) {
                var d = this.collapsed, c = {container: this.startContainer, offset: this.startOffset}, e = {container: this.endContainer, offset: this.endOffset};
                if (b) {
                    a(c);
                    d || a(e)
                }
                return{start: c.container.getAddress(b), end: d ? null : e.container.getAddress(b),
    ...
    (function () {
        ...
        function x(a, b, d, e) {
            ...
            if (e.doFilter) {
                a:{
                    ...
                    r = e.skipRequired;
                    y = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: false, allClasses: false, allStyles: false, hadInvalidAttribute: false, hadInvalidClass: false, hadInvalidStyle: false};
                    var q, w;
                    if (!a && !k)a = null; else {
                        s(b);
                        if (l) {
                    ...
                    for (var f = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || e.name == "body", g, o = c.length; o > 0;) {
                        ...
                        if (f && (j.type == CKEDITOR.NODE_TEXT || j.type == CKEDITOR.NODE_ELEMENT && F.$inline[j.name])) {
                            ...
                            g =
                                null;
                            j.insertAfter(a);
                            e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (j.type == CKEDITOR.NODE_ELEMENT && !F[e.name][j.name]) && d.push({check: "el-up", el: j})
                        }
                    }
                    a.remove()
                }
        ...
        CKEDITOR.filter.prototype = {allow: function (b, d, c) {
            ...
            var e = this, f = [], o = this.editor && this.editor.config.protectedSource, k, l = false, g = {doFilter: !d, doTransform: true, doCallbacks: true, toHtml: b};
            a.forEach(function (a) {
                if (a.type == CKEDITOR.NODE_ELEMENT) {
            ...
            check: function (a, b, d) {
                ...
                if (typeof a == "string") {
                    ...
                    e = {name: c.element, attributes: j, classes: j["class"] ? j["class"].split(/\s+/) : [], styles: e, children: []}
                }
        ...
        var t = {styles: 1, attributes: 1, classes: 1}, E = {styles: "requiredStyles", attributes: "requiredAttributes",
            classes: "requiredClasses"}, y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, C = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, ba = /^cke:(object|embed|param)$/, ca = /^(object|embed|param)$/, G = CKEDITOR.filter.transformationsTools = {sizeToStyle: function (a) {
    ...
    CKEDITOR.htmlParser.comment.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_COMMENT, filter: function (a, c) {
        var b = this.value;
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.text.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_TEXT, filter: function (a, c) {
    ...
    (function () {
        ...
        var c = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = {ol: 1, ul: 1}, f = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style: 1, script: 1}), d = {ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td"};
    ...
    (function () {
            ...
            function o(a, d) {
                return function (c) {
                    if (c.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (j = typeof d == "function" ? d(c) !== false : d)if (!v && !CKEDITOR.env.needsBrFiller &&
        ...
        function o(a, b) {
            ...
            {id: 1}), f = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, c = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(c), a = a.replace(/<\!--[\s\S]*?--\>/g, function (a) {
        ...
        {toHtml: function (a, b, d, c) {
            ...
            return e.fire("toHtml", {dataValue: a, context: f, fixForBody: d, dontFilter: c, filter: j || e.filter, enterMode: k || e.enterMode}).dataValue
            ...
            return this.editor.fire("toDataFormat", {dataValue: a,
                filter: c || this.editor.filter, context: d, enterMode: e || this.editor.enterMode}).dataValue
        }};
        var u = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", k = CKEDITOR.dtd, l = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], j = CKEDITOR.tools.extend({}, k.$blockLimit, k.$block), v = {elements: {input: n, textarea: n}}, I = {attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""]
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, c = a.element, n = a.elementMode,
                h = a.fire("uiSpace", {space: "top", html: ""}).html, i = a.fire("uiSpace", {space: "bottom", html: ""}).html;
            ...
            b = CKEDITOR.dom.element.createFromHtml(f.output({id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: [a.lang.editor, a.name].join(", "), topHtml: h ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' + h + "</span>" : "", contentId: a.ui.spaceId("contents"), bottomHtml: i ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" role="presentation">' + i + "</span>" : "", outerEl: CKEDITOR.env.ie ? "span" : "div"}));
            if (n == CKEDITOR.ELEMENT_MODE_REPLACE) {
                c.hide();
                b.insertAfter(c)
            } else c.append(b);
    ...
    (function () {
        ...
        var x = function () {
                    ...
                    if (a(e)) {
                        ...
                        if (s && j in CKEDITOR.dtd.$list)l = l.concat(b(e, d)); else {
                            ...
                            n == -1 && !k && (n =
                                h);
                            k || (q = h);
                            l.push({isElement: 1, isLineBreak: p, isBlock: e.isBlockBoundary(), hasBlockSibling: f, node: e, name: j, allowed: k});
                            f = p = 0
                        }
            ...
            function d(b) {
                return b && a(b) && (b.is(g.$removeEmpty) ||
            ...
            function j(b, c) {
                ...
                var e = c.endContainer.getChild(c.endOffset), f = c.endContainer.getChild(c.endOffset -
                    1);
                e && d(e, b[b.length - 1]);
                if (f && d(f, b[0])) {
            ...
            return function (h, m, q) {
                ...
                if (!s.checkReadOnly()) {
                    var z = (new CKEDITOR.dom.elementPath(s.startContainer,
                        s.root)).blockLimit || s.root, m = {type: m, dontFilter: w, editable: h, editor: p, range: s, blockLimit: z, mergeCandidates: [], zombies: []}, p = m.range, w = m.mergeCandidates, t, E, y, C;
                    ...
                    t = p.createBookmark();
                    (z = t.startNode.getPrevious(f)) && a(z) &&
                    d(z) && w.push(z);
                    ...
                    if (t = q) {
                        ...
                        if (/^\s+|\s+$/.test(q) && "span"in CKEDITOR.dtd[C])var x = '<span data-cke-marker="1">&nbsp;</span>',
                            q = x + q + x;
                        q = m.editor.dataProcessor.toHtml(q, {context: null, fixForBody: false, dontFilter: m.dontFilter, filter: m.editor.activeFilter, enterMode: m.editor.activeEnterMode});
                    ...
                    if (t) {
                        ...
                        for (j(E, G); t < E.length; t++) {
                            ...
                            if (B)w = t > 0; else {
                                B = G.startPath();
                                if (!y.isBlock && m.editor.config.autoParagraph !== false && (m.editor.activeEnterMode != CKEDITOR.ENTER_BR && m.editor.editable().equals(B.blockLimit) && !B.block) && (Q = m.editor.activeEnterMode != CKEDITOR.ENTER_BR && m.editor.config.autoParagraph !== false ? m.editor.activeEnterMode == CKEDITOR.ENTER_DIV ?
                                    "div" : "p" : false)) {
                                    Q = x.createElement(Q);
                                    Q.appendBogus();
                                    G.insertNode(Q);
                    ...
                    for (U = K.createBookmark(); H =
                        m.zombies.pop();)if (H.getParent()) {
                        Q = K.clone();
    ...
    (function () {
        ...
        var I = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, r =
        {a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, O = /\s*(?:;\s*|$)/, S = /#\((.+?)\)/g, F = CKEDITOR.dom.walker.bookmark(0, 1), D = CKEDITOR.dom.walker.whitespaces(1);
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {attachStyleStateChange: function (a, c) {
        ...
        function v(b) {
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    k.setStyles({position: "absolute", top: c.getScrollPosition().y - f + 10 + "px",
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("enterkey", {init: function (c) {
            c.addCommand("enter", {modes: {wysiwyg: 1}, editorFocus: !1, exec: function (c) {
                l(c)
            }});
            c.addCommand("shiftEnter", {modes: {wysiwyg: 1}, editorFocus: !1, exec: function (c) {
        ...
        CKEDITOR.plugins.enterkey = {enterBlock: function (c, e, b, h) {
            if (b = b || q(c)) {
                ...
                if (j && i) {
                    if (a && (a.is("li") || a.getParent().is("li"))) {
                        ...
                        if (d.is("li"))if (h || m)a[h ? "insertBefore" : "insertAfter"](d); else a.breakParent(d); else {
                            if (c)if (d = f.createElement(e == CKEDITOR.ENTER_P ? "p" : "div"), l && d.setAttribute("dir", j), n && d.setAttribute("style", n), i && d.setAttribute("class", i), a.moveChildren(d), h || m)d[h ?
                                "insertBefore" : "insertAfter"](b); else a.breakParent(b), d.insertAfter(b); else if (a.appendBogus(!0), h || m)for (; f = a[h ? "getFirst" : "getLast"]();)f[h ? "insertBefore" : "insertAfter"](b); else for (a.breakParent(b); f = a.getLast();)f.insertAfter(b);
                            a.remove()
                        }
                        k.selectBookmarks(g);
                        return
                ...
                if (i = b.splitBlock(k)) {
                    ...
                    if (!c && !j)a.is("li") && (d = b.clone(), d.selectNodeContents(a), d = new CKEDITOR.dom.walker(d), d.evaluator = function (a) {
                        ...
                        d ? h && !d.is("li") && d.renameNode(k) : g && g.is("li") ? d = g : (d = f.createElement(k), e && (m = e.getDirection()) && d.setAttribute("dir",
                            m));
                        if (f = i.elementPath) {
                            h = 0;
                        ...
                        if (CKEDITOR.env.ie && c && (!j || !e.getChildCount()))b.moveToElementEditStart(j ? e : d), b.select();
            ...
            if (b = b || q(c)) {
                var f =
                    b.document, j = b.checkEndOfBlock(), i = new CKEDITOR.dom.elementPath(c.getSelection().getStartElement()), a = i.block, k = a && i.block.getName();
    ...
    CKEDITOR.plugins.add("inlinecancel", {init: function (a) {
        a.addCommand("inlinecancel", {exec: function () {
            confirm("Avbryt og last siden på nytt? (Data som ikke er lagret vil gå tapt)") && location.reload(!0)
        }});
        a.ui.addButton("Inlinecancel", {label: "Cancel and Reload Page", command: "inlinecancel", icon: this.path + "images/inlinecancel.png"})
    }});
    CKEDITOR.plugins.add("inlinesave", {init: function (a) {
        a.addCommand("inlinesave", {exec: function (a) {
            (function () {
                var b = a.getData();
                jQuery.ajax({type: "POST", url: dump_file, data: {editabledata: b, context: a.element.getAttribute("data-context")}}).done(function (a, b, c) {
                    alert("Innholdet ble lagret.")
                }).fail(function (a) {
                    alert("Kunne ikke lagre innholdet")
                })
            })()
        }});
        console.log(a.responseText);
        a.ui.addButton("Inlinesave", {label: "Save", command: "inlinesave", icon: this.path + "images/inlinesave.png"})
    }});
    (function () {
        function g(a, b) {
    ...
    CKEDITOR.plugins.add("locationmap", {icons: "locationmap", init: function (a) {
        a.addCommand("locationmapDialog", new CKEDITOR.dialogCommand("locationmapDialog"));
        a.ui.addButton("LocationMap", {label: "Insert Map", command: "locationmapDialog", toolbar: "document"});
        a.contextMenu && (a.addMenuGroup("locationmapGroup"), a.addMenuItem("locationmapItem", {label: "Edit Location Map", icon: this.path + "icons/locationmap.png", command: "locationmapDialog", group: "locationmapGroup"}), a.contextMenu.addListener(function (a) {
            if (a.getAscendant("img",
                !0) && "cke_iframe" == a.$.className && (url = decodeURIComponent(a.$.attributes["data-cke-realelement"].nodeValue), el = document.createElement("div"), el.innerHTML = url, url = el.getElementsByTagName("iframe")[0].getAttribute("src"), url = url.substring(url.lastIndexOf("?") + 1), -1 < parseInt(url.search("googlemap"))))return{locationmapItem: CKEDITOR.TRISTATE_OFF}
        }));
        CKEDITOR.dialog.add("locationmapDialog", this.path + "dialogs/locationmap.js")
    }});
    CKEDITOR.config.plugins = 'basicstyles,blockquote,dialogui,dialog,clipboard,panel,floatpanel,menu,contextmenu,elementspath,enterkey,entities,floatingspace,listblock,button,richcombo,format,horizontalrule,htmlwriter,image,indent,indentlist,inlinecancel,inlinesave,fakeobjects,link,list,magicline,pastefromword,pastetext,removeformat,sourcearea,specialchar,stylescombo,tab,table,tabletools,toolbar,undo,liststyle,locationmap';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,horizontalrule,312,,image,336,,indent-rtl,360,,indent,384,,outdent-rtl,408,,outdent,432,,anchor-rtl,456,,anchor,480,,link,504,,unlink,528,,bulletedlist-rtl,552,,bulletedlist,576,,numberedlist-rtl,600,,numberedlist,624,,pastefromword-rtl,648,,pastefromword,672,,pastetext-rtl,696,,pastetext,720,,removeformat,744,,source-rtl,768,,source,792,,specialchar,816,,table,840,,redo-rtl,864,,redo,888,,undo-rtl,912,,undo,936,,locationmap,1920,auto', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,horizontalrule,312,auto,image,336,auto,indent-rtl,360,auto,indent,384,auto,outdent-rtl,408,auto,outdent,432,auto,anchor-rtl,456,auto,anchor,480,auto,link,504,auto,unlink,528,auto,bulletedlist-rtl,552,auto,bulletedlist,576,auto,numberedlist-rtl,600,auto,numberedlist,624,auto,pastefromword-rtl,648,auto,pastefromword,672,auto,pastetext-rtl,696,auto,pastetext,720,auto,removeformat,744,auto,source-rtl,768,auto,source,792,auto,specialchar,816,auto,table,840,auto,redo-rtl,864,auto,redo,888,auto,undo-rtl,912,auto,undo,936,auto,locationmap,960,auto', 'icons.png');
    })();
    CKEDITOR.lang.languages = {"en": 1, "nb": 1};
}());